...
1. Read `project/AI_HANDOFF.md`, `project/MILESTONES.md`, `project/TESTING.md`, and
   `project/QA_ADAPTER.md`. Current mod source under `project/` is v0.9.9 H2.5 normal-lifecycle QA.
