...
cd /d "%~dp0"
title Unspottable Expanded v0.9.6 - QA Verification

echo ============================================================
echo  Unspottable Expanded v0.9.6 - QA VERIFICATION
...
(
  echo Unspottable Expanded 0.9.6 QA VERIFICATION
...
echo.
echo ============================================================
echo SUCCESS - v0.9.6 INSTALLED AND GAME LAUNCHED
echo ============================================================
echo.
echo TEST:
...
echo.
echo ============================================================
echo SUCCESS - v0.9.6 BUILT AND INSTALLED (NOT LAUNCHED)
echo ============================================================
echo.
exit /b 0
