...
cd /d "%~dp0"
title Unspottable Expanded v0.9.10 - QA Verification

echo ============================================================
echo  Unspottable Expanded v0.9.10 - QA VERIFICATION
...
(
  echo Unspottable Expanded 0.9.10 H2.6 NORMAL LIFECYCLE
...
echo.
echo ============================================================
echo SUCCESS - v0.9.10 INSTALLED AND GAME LAUNCHED
echo ============================================================
echo.
echo TEST:
...
echo.
echo ============================================================
echo SUCCESS - v0.9.10 BUILT AND INSTALLED (NOT LAUNCHED)
echo ============================================================
echo.
exit /b 0
